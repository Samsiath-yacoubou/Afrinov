 ...
 */
final class Version20250527195601 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            ALTER TABLE user CHANGE roles roles LONGTEXT NOT NULL COLLATE `utf8mb4_bin`, CHANGE photoprofil photoprofil VARCHAR(255) DEFAULT 'NULL', CHANGE lieu lieu VARCHAR(255) DEFAULT 'NULL', CHANGE apropos apropos VARCHAR(255) DEFAULT 'NULL', CHANGE tel tel VARCHAR(255) DEFAULT 'NULL', CHANGE facebook facebook VARCHAR(255) DEFAULT 'NULL', CHANGE linkedin linkedin VARCHAR(255) DEFAULT 'NULL', CHANGE twiter twiter VARCHAR(255) DEFAULT 'NULL', CHANGE competences competences LONGTEXT DEFAULT NULL COLLATE `utf8mb4_bin`, CHANGE token token VARCHAR(255) DEFAULT 'NULL'
        SQL);
    }
}
